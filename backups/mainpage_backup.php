...
<body>
    ...
    $last_ros = $baglanti->query("SELECT * FROM ros ORDER BY ros_id DESC LIMIT 1");
    $last_total_ros = $last_ros->fetch_array();
    ...
    <!-- <img src="media/octo.png" width="90"> // -->
        ...
        <div class="roses">
            <?php
            $sonuc_ros = $baglanti->query("SELECT * FROM ros ORDER BY ros_id DESC LIMIT 50");
            ...
            ?>
                ...
                <div class="comment">
                    ...
                    <div class="comment_name"><?php echo($comment_array['cmt_author']) ?></div>
